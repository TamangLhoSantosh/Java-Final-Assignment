...
public class DoublePage extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DoublePage frame = new DoublePage();
	...
	public DoublePage() {
		...
		JLabel name = new JLabel("Double Room");
		...
		bedding.setText("Bed Max Occupancy : 2");
		panel2.add(bedding);
		...
		roomFeatures.setText("Room Features: 25sqm/265sq, Air-conditioned, and SoundProof");
		...
		rate.setText("USD 200 Per Night");
		panel9.add(rate);
		...
		bookNow.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				DoubleBooking db = new DoubleBooking();
				db.setVisible(true);
				dispose();
			}
		});
